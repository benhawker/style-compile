...
RSpec.describe V1::StylesheetsController, :type => :controller do
  ...
  describe "#create" do
    before do
      ...
      # Do not persist any test related compiled stylesheets to the public dir.
      allow_any_instance_of(StylesheetPublisher).to receive(:path).and_return(Rails.root.join("spec/assets/"))
    end

    it "responds with the stylesheet when compilation is successful" do
      post :create, params
    ...
    # Remove the files generated by the call to the create action.
    after do
      FileUtils.rm_rf(Rails.root.join("spec/assets/."), secure: true)
    end
  end
end
